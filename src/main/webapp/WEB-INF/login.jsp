...
<body>
	...
	<div class="middle">
		<div class="middle_deco">
			<table class="table">
				<tr>
					<td><img src="images/wisdom.png" class="login_exam"></td>
					<td class="login_title">&nbsp;&nbsp;智慧脑测试训练系统&nbsp;&nbsp;</td>
				</tr>
			</table>
		</div>
		<!--中间登录-->
				...
				<table class="main_font login_table">
					...
					<tr>
						...
						<td><input id="radio_student" type="radio" name="role"
							value="1" checked> <label for="radio_student">受测人员</label>
							<input id="radio_teacher" type="radio" name="role" value="2">
							<label for="radio_teacher">测试人员</label>
